...
export const API_ENDPOINTS = {
  ...
  TOOLS: {
    ...
    TRUE_REDACT: `${API_BASE_URL}/true-redact`,
    TRUE_REDACT_PREVIEW: `${API_BASE_URL}/true-redact/preview`,
    QRCODE: `${API_BASE_URL}/qrcode`,
    QRCODE_PREVIEW: `${API_BASE_URL}/qrcode/preview`,
    HEADER_FOOTER: `${API_BASE_URL}/header-footer`,
    LOCK_SET: `${API_BASE_URL}/lock/set`,
    LOCK_CHECK: `${API_BASE_URL}/lock/check`,
    LOCK_OPEN: `${API_BASE_URL}/lock/open`,
    LOCK_REVOKE: `${API_BASE_URL}/lock/revoke`,
    LOCK_EMBED: `${API_BASE_URL}/lock/embed`,
    LOCK_READ_METADATA: `${API_BASE_URL}/lock/read-metadata`,
    LOCK_CORRUPT: `${API_BASE_URL}/lock/corrupt`,
